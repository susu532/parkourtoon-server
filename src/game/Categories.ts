...
export function getItemCategory(type: ItemType): ItemCategory {
  ...
  if (
    nameUpper.includes("PICKAXE") ||
    nameUpper.includes("SHOVEL") ||
    nameUpper.includes("AXE") ||
    nameUpper.includes("ROD")
  ) {
    if (!nameUpper.includes("BLOCK")) return ItemCategory.TOOLS;
  }

  if (
    nameUpper.includes("SWORD") ||
    nameUpper.includes("BOW") ||
    nameUpper.includes("ARROW")
  ) {
  ...
  if (
    ...
    nameUpper.includes("BEEF") ||
    nameUpper.includes("BREAD") ||
    nameUpper.includes("WHEAT") ||
    nameUpper.includes("STEAK") ||
    nameUpper.includes("CAKE") ||
    nameUpper.includes("MELON") ||
    nameUpper.includes("PUMPKIN")
  ) {
    return ItemCategory.FOOD;
  }

  if (
    nameUpper.includes("REDSTONE") ||
    nameUpper.includes("OBSERVER") ||
    nameUpper.includes("TARGET") ||
    nameUpper.includes("DISPENSER") ||
    nameUpper.includes("DROPPER") ||
    nameUpper.includes("DETECTOR") ||
    nameUpper.includes("HOPPER") ||
    nameUpper.includes("LAMP")
  ) {
